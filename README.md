...
I just realize I can also achieve the same thing by single precision floating point conversion because the 32 bit of floating point has nothing to do with the 32 bit processors.... But I believe the performance should be the same, so I will leave this double conversion here :D.
